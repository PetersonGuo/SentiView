...
export default function Nav() {
  ...
  return (
    <Navbar className="pl-[5%] self-start border-0 bg-darkBg">
      <button
        className="flex flex-row my-1 lg:my-2"
        onClick={animate}
        onAnimationEnd={reset}
      >
        <Rocket id="rocket" className="rocket float cursor-pointer ml-0 mr-2" />
